<?php
/**
 * Plugin Name: Award Role Add-On for BadgeOS
 ...
 * Tags: badgeos, achievement, achievements, role, roles
 * Author: konnektiv
 * Version: 1.1.1
...
class BadgeOS_Award_Role {
	...
	public static function meets_requirements() {
		...
		if ( class_exists( 'BadgeOS' ) && version_compare( BadgeOS::$version, '3.0.0', '>=' ) ) {
			return true;
		} else {
			return false;
		}
	...
	public function maybe_disable_plugin() {
		if ( ! $this->meets_requirements() ) {
			...
			echo '<p>' . sprintf( __( 'BadgeOS Award Role Add-On requires BadgeOS 3.0.0 or greater and has been <a href="%s">deactivated</a>. Please install and activate BadgeOS and then reactivate this plugin.', 'badgeos-award-role' ), admin_url( 'plugins.php' ) ) . '</p>';
			echo '</div>';
